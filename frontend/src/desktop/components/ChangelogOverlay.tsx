                                    ...
                                    <div className="bg-blue-500/5 border border-blue-500/10 rounded-xl p-3 backdrop-blur-sm space-y-2">
                                        <div>
                                            ...
                                            <p className="text-xs text-gray-500 leading-relaxed">
                                                The protocol now supports encrypted USDC natively via fhEVM. Settlements engage the BlindPay contract directly using FHE-encrypted amounts. This ensures <strong>atomic execution</strong>: the transfer and receipt generation happen in a single, inseparable step.
                                            </p>
                                        </div>
                                    </div>
                                </div>
